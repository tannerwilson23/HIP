#mixing and gce offset code for the supernova mixing
...
for initial in initials:
	...
	#plot the mixed in abundances and HIP
	mix1 = '%.2E' % decimal.Decimal(mix1)
	plt.plot(num, xhmixed, label = "Supernova")
	plt.errorbar(chargeno, xh, yerr=error, capsize = 4, label = "HIP 11915", fmt = "o")


	#plot the gce offset on the mixes
	plt.plot(num, xhmixed2, label = "GCE offsets")
